...
@class LINConversionView;

@protocol LINConversionViewDelegate <NSObject>
...
typedef NS_ENUM(NSInteger, LINConversionViewStyle) {
    LINConversionViewStyle_Sticker,
    LINConversionViewStyle_Bubble
};
...
@property(nonatomic,weak) id <LINConversionViewDelegate> delegate;
...
@property(nonatomic,assign)LINConversionViewStyle style;

@property(nonatomic,assign)BOOL isEdit; //当前状态
