...
typedef NS_ENUM(NSInteger, DWCropAreaCornerPosition) {
    DWCropAreaCornerPositionTopLeft,
    DWCropAreaCornerPositionTopRight,
    DWCropAreaCornerPositionBottomLeft,
    DWCropAreaCornerPositionBottomRight
};
typedef NS_ENUM(NSInteger, DWMidLineType) {
...
@property (assign, nonatomic) DWCropAreaCornerPosition cornerPosition;
...
- (void)setCornerPosition:(DWCropAreaCornerPosition)cornerPosition {
...
- (void)drawCornerLines {
    ...
    switch (_cornerPosition) {
        case DWCropAreaCornerPositionTopLeft: {
        ...
        case DWCropAreaCornerPositionTopRight: {
        ...
        case DWCropAreaCornerPositionBottomLeft: {
        ...
        case DWCropAreaCornerPositionBottomRight: {
...
@property (strong, nonatomic) UIColor *lineColor;
@property (assign, nonatomic) DWMidLineType type;
@end
...
- (void)setType:(DWMidLineType)type {
...
- (void)drawMidLine {
    ...
    switch (_type) {
        case DWMidLineTypeTop:
        case DWMidLineTypeBottom: {
        ...
        case DWMidLineTypeRight:
        case DWMidLineTypeLeft: {
...
- (void)createCorners {
    ...
    _topLeftCorner.cornerPosition = DWCropAreaCornerPositionTopLeft;
    ...
    _topRightCorner.cornerPosition = DWCropAreaCornerPositionTopRight;
    ...
    _bottomLeftCorner.cornerPosition = DWCropAreaCornerPositionBottomLeft;
    ...
    _bottomRightCorner.cornerPosition = DWCropAreaCornerPositionBottomRight;
...
- (void)createMidLines {
    ...
    _topMidLine.type = DWMidLineTypeTop;
    ...
    _bottomMidLine.type = DWMidLineTypeBottom;
    ...
    _leftMidLine.type = DWMidLineTypeLeft;
    ...
    _rightMidLine.type = DWMidLineTypeRight;
...
//    _cropAreaView.frame = CGRectMake(0, (HEIGHT(_imageView) - height) / 2.0,_imageView.frame.size.width, height);
    [self resetCornersOnCropAreaFrameChanged];
    [self resetCropTransparentArea];
...
- (UIImage *)currentCroppedImage {
    ...
    NSLog(@"rect:_____%@",NSStringFromCGRect(rect));
    return [_toCropImage imageAtRect:rect];
    
}

- (CGRect )currentCroppedRect{
