...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *uploadItem = [[UIBarButtonItem alloc] initWithTitle:@"上传" style:UIBarButtonItemStylePlain target:self action:@selector(uploadAction:)];
...
- (void)uploadAction:(UIBarButtonItem *)item
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"uploadVideo" object:nil userInfo:@{@"videoTitle":self.videoTitle?:@"",
                                                                                                    @"videoTag":self.videoTag?:@"",
